        ...
        <div className='digits-landing-background'>
          <Grid container centered stackable columns={3}>
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header as='h3' inverted>This address book enables any number ot users to register and save their
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header as='h3' inverted>Each time you make contact with a contact, you can write a note that
                summarizes the converstaion. This note is saved along with a timestamp with the contact.</Header>
            </Grid.Column>
